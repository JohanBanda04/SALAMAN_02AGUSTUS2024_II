...
<div id="appCapsule" class="pt-0">
    ...
    text-align: center;" class="card gradasikodebooking">
        ...
        @endif
        <div class="section">
            <img src="{{ asset('assets/img/login/handshaking.jpeg') }}" alt="image"
                 style="height: 130px; width: 130px; border-radius: 20px;"
                 class="form-image">
        </div>
        <div class="section mt-0">
            <h1>SALAMAN</h1>
            <h3>Sistem Layanan</h3>
            <h2>Peminjaman </h2>
    ...
    text-align: center;" class="card gradasired">
                <a href="{{ route('formpinjamruangan') }}" id="btnTambahPinjamRuangan"
                   style="text-decoration: none; color:white">
                    <div class="card-body">
                        <div class="presencecontent">
                            Pinjam Ruangan
