...
where tgl_pinjam='$tgl_torent' and kode_ruangan='$kode_ruangan'"));
        ...
        //echo "<pre>"; print_r($keep_data_ruangan); die;

        $filterBy = "Booked";
        $ruangan_terbooking = array_filter($keep_data_ruangan, function ($var) use ($filterBy) {
            return ($var->status == $filterBy);
        });

        //echo "<pre>"; print_r($ruangan_terbooking);die;
        if (count($ruangan_terbooking) > 0) {
            $simpan_indikator = "n";
        } else if (count($ruangan_terbooking) <= 0) {
            $simpan_indikator = "y";
        }

        /*$keep_data_ruangan merupakan data array campuran keseluruhan yg terbooking maupun available */
        ...
        //echo $tanggal_gagal_ruangan; die;
